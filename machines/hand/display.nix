  ...
  home-manager.users."breakds" = {
    ...
    programs.autorandr = {
      ...
      profiles = {
        ...
        # +-----------------------+    +-------------------------------+
        # |   Laptop Display      |    |   RedMi 27's Monitor          |
        # |   2556 x 1504         |    |   3840 x 2160 (4k)            |
        # |                       |    |                               |
        # |                       |    |                               |
        # |                       |    |                               |
        # |                       |    |                               |
        ...
        "quant" = {
          fingerprint = {
            "eDP-1" = "";
            "DP-1" = "";
          };
          config = {
            # Left
            "eDP-1" = {
